...
`minecraft-skills vanilla-inventory <version>` to inspect bundled vanilla `data/<namespace>/...`
top-level directories, counts, and representative paths for Java 1.13+. When a requested fact is not extracted,
