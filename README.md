...
Version 0.1.9 includes Java 26.3 data and Paper 26.3 build 5 (ALPHA), with exact-version
command trees, block states, entity metadata and tag resolution. See the
