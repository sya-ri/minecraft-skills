    ...
    commands.push(
      runCommand(
        ...
        [
          ...
          "--eval",
          [
            'import { getCoverageSummary, getDataManifest, getDatapackSchemaSurface, getFactSurface, getPaperApiSurface, getSupportMatrix, listFactSurfaces } from "@minecraft-skills/catalog";',
