...
- CLI: `minecraft-skills version show <version>`, `minecraft-skills version pack-formats`,
  `minecraft-skills authoring preflight resourcepack <version>`,
  ...
  `minecraft-skills authoring search-scenarios "<task>" --domain resourcepack`,
  ...
  `minecraft-skills authoring claim-policies --domain resourcepack`,
  `minecraft-skills authoring output-requirements --domain resourcepack`,
  `minecraft-skills authoring response-patterns --domain resourcepack`,
  `minecraft-skills authoring response-pattern <id>`,
  `minecraft-skills authoring evidence resourcepack <version>`,
  `minecraft-skills authoring intents --domain resourcepack`,
  ...
  `minecraft-skills authoring fact-surfaces --domain resourcepack`,
  `minecraft-skills data support-matrix`,
  `minecraft-skills version compare <from> <to>`, `minecraft-skills resourcepack vanilla-paths <version>`,
  `minecraft-skills resourcepack compare-vanilla-paths <from> <to>`,
  `minecraft-skills resourcepack vanilla-inventory <version>`,
